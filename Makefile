...
generate-data: all
	$(GENERATE_DATA) ./boomerang.exe examples/synth_examples/bijective_optician_tests/ bijective_data
	$(GENERATE_DATA) ./boomerang.exe examples/synth_examples/symmetric_optician_tests/ symmetric_data
